...
BaseParser &
BaseParser::wantlist( const std::string & fn ) {
...
const BaseParser &
BaseParser::print( std::ostream &os ) const {
...
const BaseParser &
BaseParser::showOptions( std::ostream & os ) const {
...
std::string
BaseParser::getPriorityScheme() const {
	return _priority_scheme;
}

bool
BaseParser::hideNonTrades() const {
...
BaseParser &
BaseParser::_parseOption( const std::string & option_line ) {
...
BaseParser &
BaseParser::_parseOfficialName( const std::string & line ) {
...
BaseParser &
BaseParser::_parseWantList( const std::string & line ) {
...
BaseParser &
BaseParser::_parseItemName( std::string & item,
...
bool
BaseParser::_dummy( const std::string & item ) {
 ...
 */
const std::unordered_map< std::string, BaseParser::BoolOption  >
BaseParser::_bool_option_map = {
 ...
 * Unordered_map to map string-options to enums.
 */
const std::unordered_map< std::string, BaseParser::IntOption  >
BaseParser::_int_option_map = {
