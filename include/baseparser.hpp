...
public:
	 ...
	 * @return *this
	 */
	const BaseParser & print( std::ostream & os = std::cout ) const ;
	 ...
	 * @return *this
	 */
	const BaseParser & print( const std::string & fn ) const ;


	/**
	 * @brief Show options.
	 * Prints the options of BaseParser.
	 * @param os The output stream (default: std::cout).
	 * @return *this
	 */
	const BaseParser & showOptions( std::ostream & os = std::cout ) const ;
	 ...
	 * it's not the responsibility of BaseParser to check
	 * its validity.
...
private:
	 ...
	 * @brief Parse option
	 */
	BaseParser & _parseOption( const std::string & option );
